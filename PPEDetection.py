...
if(n==1):
    ...
    import cvzone
    import math
    import winsound  # Add this import for Windows system beep
    ...
    cap = cv2.VideoCapture("D:\PROJECT 1\ppe-4.mp4")
    ...
    while True:
        ...
        noPPEDetected = False  # Flag to check if someone is not wearing PPE
        ...
        if noPPEDetected:
            winsound.Beep(1000, 500)  # Play a beep sound if no PPE is detected
    ...
    cap = cv2.VideoCapture(1)  # For Webcam --with code
    #cap = cv2.VideoCapture(0)  # inbuilt cam
    cv2.namedWindow("Window")  # inbuilt cam1
    cap.set(3, 1280)  # cam
    cap.set(4, 720)  # cam
    # cap = cv2.VideoCapture("../Videos/ppe-3.mp4")  # For Video
    # cap = cv2.VideoCapture("C:/Users/krish/Desktop/new project/Videos/ppe-4.mp4")
